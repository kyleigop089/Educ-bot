...
module.exports.run = async function ({
	...
	try {
		...
		if (!input) {
			...
			let end = start + pages;
			let helpMessage = `[📖] - 𝗘𝗱𝘂𝗰𝗮𝘁𝗶𝗼𝗻 𝗕𝗼𝘁 𝗖𝗠𝗗 𝗟𝗜𝗦𝗧\n`;
			for (let i = start; i < Math.min(end, commands.length); i++) {
